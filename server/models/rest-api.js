...
*/
  Restapi.getPartnerRefined = function (Long, Lat, MasterCat, FilterString, Radius, Partner,SortCol, cb) {
    getPartnerRefined.getPartnerRefined(ds, Long, Lat, MasterCat, FilterString, Radius, Partner,SortCol, cb);
  };
